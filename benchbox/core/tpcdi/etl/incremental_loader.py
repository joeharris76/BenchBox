...
class IncrementalDataLoader:
    ...
    def get_watermark(self, table_name: str) -> Optional[Any]:
        """Get watermark value for a table.
        ...
        """
        return self.table_watermarks.get(table_name)

    def detect_changes(self, table_name: str, last_watermark: Any, batch_id: int) -> list[dict[str, Any]]:
