...
class TransactionPrimitivesDataGenerator(CompressionMixin, CloudStorageGeneratorMixin, VerbosityMixin):
    """Transaction Primitives data generator.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """Initialize Transaction Primitives data generator.
        ...
        self.logger = logging.getLogger("benchbox.core.transaction_primitives.generator")
        ...
        self.files_dir = self.output_dir / "transaction_primitives_auxiliary"
        self.staging_data: dict[str, Path] = {}

    def generate(self) -> dict[str, Path]:
        """Generate all data for transaction primitives benchmark.
    ...
    def _generate_staging_table_files(self) -> dict[str, Path]:
        ...
        Creates .tbl files for Transaction Primitives staging tables:
    ...
    def _write_manifest(self, table_paths: dict[str, Path]) -> None:
        """Write data generation manifest for Transaction Primitives benchmark.
...
__all__ = ["TransactionPrimitivesDataGenerator"]
