...
# Import common types instead of local types to avoid circular imports
...
class BenchmarkManager:
    ...
    # Benchmark popularity order within each category (most popular first)
    BENCHMARK_ORDER = {
    ...
    def _get_available_benchmarks(self) -> dict[str, dict[str, Any]]:
        ...
        return {
            ...
            "tpchavoc": {
                ...
                "category": "Experimental",
                "num_queries": 220,
                "query_description": "220 query variants (22 queries × 10 variants)",
                "supports_streams": False,
                "default_scale": 0.01,
                "scale_options": [0.01, 0.1, 1.0, 10.0],
                "complexity": "High",
    ...
    def validate_scale_factor(self, benchmark_id: str, scale_factor: float) -> None:
        ...
        bench_info = self.benchmarks[benchmark_id]
        min_scale = bench_info.get("min_scale")
