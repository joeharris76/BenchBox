...
class TestListBenchmarksTool:
    ...
    def test_benchmark_has_required_fields(self):
        ...
        for name, meta in manager.benchmarks.items():
...
class TestGetBenchmarkInfoTool:
    ...
    def test_get_tpch_info(self):
        ...
        manager = BenchmarkManager()
        assert "tpch" in manager.benchmarks

        meta = manager.benchmarks["tpch"]
    ...
    def test_get_tpcds_info(self):
        ...
        manager = BenchmarkManager()
        assert "tpcds" in manager.benchmarks

        meta = manager.benchmarks["tpcds"]
    ...
    def test_unknown_benchmark_error(self):
        ...
        manager = BenchmarkManager()
        assert "nonexistent_benchmark" not in manager.benchmarks
