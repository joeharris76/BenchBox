...
def test_tpcds_compliance():
    ...
    try:
        ...
        config = MaintenanceTestConfig(concurrent_streams=2, maintenance_interval=30.0, scale_factor=0.01)

        if config.concurrent_streams == 2 and config.maintenance_interval == 30.0:
