...
- `ClickBench Methodology <https://clickhouse.com/docs/en/operations/benchmarks/>`_ - Detailed methodology
- `Analytics Database Blog <https://clickhouse.com/blog/clickbench-a-benchmark-for-analytical-databases>`_ - Design rationale
