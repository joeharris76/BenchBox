...
| [Open table formats](format-conversion.md) | Convert benchmark data to Parquet, Vortex, Delta Lake, Iceberg, Hudi, or DuckLake for optimized storage and query efficiency. |
