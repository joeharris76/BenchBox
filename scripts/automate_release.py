...
7. Build packages with SOURCE_DATE_EPOCH
8. Verify artifacts and run smoke tests
9. Finalize with git commit/tag (both with normalized timestamps)
...
def main() -> int:
    ...
    run_step(
        ...
        "Step 4/7: Preparing Public Tree",
    )
    ...
    run_step(
        "verify_release.py",
        verify_args,
        "Step 7/7: Verifying Artifacts & Running Smoke Tests",
    )
